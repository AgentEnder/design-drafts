...
import { t as require_jsx_runtime } from "./chunk-q44vHeK4.js";
...
var related_default = {
	...
	"blog:superpowered-git-aliases": [
		...
		{
			"type": "project",
			"slug": "@agentender/pristine",
			"title": "@agentender/pristine",
			"description": "A fast, git-aware replacement for `git clean -fdx` — interactively reset, remove untracked, and remove ignored files.",
			"url": "/projects#@agentender/pristine",
			"score": .7216
		},
		{
			"type": "blog",
	...
	"presentation:nx-conf-2023-inference": [
		...
		},
		{
			...
			"slug": "nx-dotnet",
			"title": "nx-dotnet",
			"description": "A Nx plugin adding support for .NET 5+ (or .net core) projects, featuring full project graph and generator support.",
			"url": "/projects#nx-dotnet",
			"score": .7982
		},
		{
			"type": "project",
	...
	"project:flexi-bench": [
		{
			...
			"url": "/presentations/view/devup-2023-benchmarking",
			"score": .8102
		},
		{
			"type": "presentation",
	...
	"project:HouseSortable": [
		{
			"type": "project",
			"slug": "breakerboxer",
			"title": "breakerboxer",
			"description": "",
			"url": "/projects#breakerboxer",
			"score": .8621
		},
		{
			"type": "project",
