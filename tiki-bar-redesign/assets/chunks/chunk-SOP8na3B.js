...
function ViewPresentation(props) {
	...
	(0, import_react.useEffect)(() => {
		...
		if (p?.mdUrl) (async function() {
			try {
				const res = (await _rolldown_dynamic_import_helper_default(/* @__PURE__ */ Object.assign({
					"../presentation-data/devup-2023-benchmarking/slides.md": () => __vitePreload(() => import("./chunk-DWShH-o-.js"), []),
					"../presentation-data/devup-2023-full-stack-type-safety/slides.md": () => __vitePreload(() => import("./chunk-SAnFWmnw.js"), []),
					"../presentation-data/kcdc-2025-monorepo-nx/slides.md": () => __vitePreload(() => import("./chunk-D6FpwxVj.js"), []),
					"../presentation-data/nx-conf-2023-inference/slides.md": () => __vitePreload(() => import("./chunk-DQnNWK_z.js"), []),
					"../presentation-data/that-conf-tx-2024-compartmentalization/slides.md": () => __vitePreload(() => import("./chunk-BsBMJaYc.js"), []),
					"../presentation-data/that-conf-wi-2023-benchmarking/slides.md": () => __vitePreload(() => import("./chunk-B6TNsfhw.js"), []),
					"../presentation-data/that-conf-wi-2024-spaghetti/slides.md": () => __vitePreload(() => import("./chunk-DkxhjwBq2.js"), [])
		...
		if (p?.scssUrl) (/* @__PURE__ */ Object.assign({
			"../presentation-data/devup-2023-benchmarking/slides.scss": () => __vitePreload(() => import("./chunk-B1MOfivB.js"), []),
			"../presentation-data/devup-2023-full-stack-type-safety/slides.scss": () => __vitePreload(() => import("./chunk-Cb5eDEhq.js"), []),
			"../presentation-data/kcdc-2025-monorepo-nx/slides.scss": () => __vitePreload(() => import("./chunk-BBCQINLj.js"), []),
			"../presentation-data/nx-conf-2023-inference/slides.scss": () => __vitePreload(() => import("./chunk-Bfd0yqnO.js"), [])
